...
let words = [
  ...
  "warmth", "echo", "attachment", "understanding", "gap", "touch",
  "separation", "relation", "사랑", "그리움", "외로움", "불안", "기대",
  "질투", "신뢰", "의심", "연결", "거리", "공감", "상처", "위로", "설렘",
  "후회", "집착", "해방", "침묵", "대화", "오해", "안정", "불편", "따뜻함",
  "차가움", "끌림", "거절", "허전함", "안도", "긴장", "피로", "희망",
  "혼란", "애착", "단절", "존중", "무관심", "열망", "체념", "기억", "여운",
];
